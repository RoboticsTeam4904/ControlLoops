class Flywheel {
  ...
  void display() {  
    ...
    ellipse(this.CIRCLE_RADIUS*cos(radians(test.angle))+MOTOR_X,
            this.CIRCLE_RADIUS*-sin(radians(test.angle))+MOTOR_Y,
            10,
            10);
